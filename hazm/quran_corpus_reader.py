...
class quran_corpus_reader():
	...
	def parts(self):
		...
		Examples:
			>>> parts=quran_corpus_reader(quran_file='corpora\quranic-corpus-morphology.txt').parts()
			>>> print(next(parts))
			>>> print(next(parts))
			>>> print(next(parts))
	...
	def words(self):
		...
		Examples:
			>>> words=quran_corpus_reader(quran_file='corpora\quranic-corpus-morphology.txt').words()
			>>> print(next(words))
