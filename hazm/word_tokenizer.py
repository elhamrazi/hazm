...
برای استخراج جملات، از تابع [sentence_tokenizer()][hazm.sentence_tokenizer] استفاده کنید.
"""
...
class word_tokenizer(TokenizerI):
