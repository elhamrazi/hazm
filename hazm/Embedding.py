...
class WordEmbedding:
    ...
    def doesnt_match(self, words):
        ...
        Examples:
            >>> word_embedding = WordEmbedding(model_type = 'model_type', model_path = 'resources/cc.fa.300.bin')
    ...
    def similarity(self, word1, word2):
        ...
        Examples:
            >>> word_embedding = WordEmbedding(model_type = 'model_type', model_path = 'resources/cc.fa.300.bin')
            >>> word_embedding.similarity('ایران', 'آلمان')
            0.44988164

            >>> word_embedding.similarity('ایران', 'پنجره')
            0.08837362
    ...
    def nearest_words(self, word, topn=5):
        ...
        Examples:
            >>> word_embedding = WordEmbedding(model_type = 'model_type', model_path = 'resources/cc.fa.300.bin')
            >>> word_embedding.nearest_words('ایران', topn = 5)
    ...
    def get_normal_vector(self, word):
        ...
        Examples:
            >>> word_embedding = WordEmbedding(model_type = 'model_type', model_path = 'resources/cc.fa.300.bin')
            >>> word_embedding.get_normal_vector('سرباز')
...
class SentEmbedding:
    ...
    def load_model(self, model_path):
        ...
        Examples:
            ...
            >>> sent_embedding.load_model('sent2vec_model_path')
    ...
    def get_sentence_vector(self, sent):
        ...
        Examples:
            >>> sent_embedding = SentEmbedding(sent_embedding_file)
            >>> sent_embedding.get_sentence_vector('این متن به برداری متناظر با خودش تبدیل خواهد شد')
    ...
    def similarity(self, sent1, sent2):
        ...
        Examples:
            >>> sent_embedding = SentEmbedding(sent_embedding_file)
            >>> sent_embedding.similarity('شیر حیوانی وحشی است', 'پلنگ از دیگر حیوانات درنده است')
            0.8748713

            >>> sent_embedding.similarity('هضم یک محصول پردازش متن فارسی است', 'شیر حیوانی وحشی است')
            0.2379288
        ...
        if not self.model:
            ...
            return float(
                str(self.model.similarity_unseen_docs(tokenized_sent1, tokenized_sent2))
            )
